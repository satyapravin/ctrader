...
namespace PMS
{
    ...
    {
        private static readonly ILog Log = log4net.LogManager.GetLogger(typeof(PositionService));
        private readonly EventWaitHandle waitHandle = new ManualResetEvent(false);
        private readonly ConcurrentDictionary<string, decimal> positions = new ConcurrentDictionary<string, decimal>();
